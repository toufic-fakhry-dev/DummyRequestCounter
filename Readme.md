...
## TP3 – Kubernetes 101 Lab
Folder: [TP3-Kubernetes](./TP3-Kubernetes)
> Flask + Redis counter app deployed on Kubernetes (Docker Desktop). Includes scaling, sidecar logging, and monitoring.
